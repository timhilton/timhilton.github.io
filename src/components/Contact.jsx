      ...
      return (
              <div className="component-wrap">
                  ...
                  <div className="contact-wrap">
                      ...
                      <div className="contact-6"><FontAwesomeIcon icon={faFilePdf}/>&nbsp;&nbsp;<a target="_blank" rel="noopener noreferrer" href="https://s3.amazonaws.com/www.timhilton.net/TimHiltonResume2021.pdf">Resume</a></div>
              </div>
